...
namespace DevelopmentBundle\Sqlsync\Model;

use Joomla\Registry\Registry;
use DevelopmentBundle\Sqlsync\Exporter\AbstractExporter;
use DevelopmentBundle\Sqlsync\Helper\ProfileHelper;
use DevelopmentBundle\Sqlsync\Importer\AbstractImporter;
use DevelopmentBundle\Sqlsync\Query\MysqlQueryBuilder;
use Symfony\Component\Yaml\Dumper;

/**
 * Class Schema
 */
class SchemaModel extends \JModelDatabase
{
	/**
	 * @var string
	 */
