...
CREATE TABLE IF NOT EXISTS `cmf_assets` (
...
INSERT INTO `cmf_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- 資料表結構 `cmf_associations`
--

CREATE TABLE IF NOT EXISTS `cmf_associations` (
...
CREATE TABLE IF NOT EXISTS `cmf_banners` (
...
--
-- 資料表結構 `cmf_banner_clients`
--

CREATE TABLE IF NOT EXISTS `cmf_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- 資料表結構 `cmf_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `cmf_banner_tracks` (
...
--
-- 資料表結構 `cmf_categories`
--

CREATE TABLE IF NOT EXISTS `cmf_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 資料表的匯出資料 `cmf_categories`
--

INSERT INTO `cmf_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- 資料表結構 `cmf_contact_details`
--

CREATE TABLE IF NOT EXISTS `cmf_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `cmf_content` (
...
--
-- 資料表結構 `cmf_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `cmf_contentitem_tag_map` (
...
--
-- 資料表結構 `cmf_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `cmf_content_frontpage` (
...
--
-- 資料表結構 `cmf_content_rating`
--

CREATE TABLE IF NOT EXISTS `cmf_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- 資料表結構 `cmf_content_types`
--

CREATE TABLE IF NOT EXISTS `cmf_content_types` (
...
--
-- 資料表的匯出資料 `cmf_content_types`
--

INSERT INTO `cmf_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- 資料表結構 `cmf_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `cmf_core_log_searches` (
...
--
-- 資料表結構 `cmf_extensions`
--

CREATE TABLE IF NOT EXISTS `cmf_extensions` (
...
--
-- 資料表的匯出資料 `cmf_extensions`
--

INSERT INTO `cmf_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"68b3a7a049618fef3e2fb12d28f80e57"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10000, '', 'language', 'zh-TW', '', 0, 1, 0, 0, '{"name":"\\u4e2d\\u6587(\\u7e41\\u9ad4\\uff0e\\u53f0\\u7063)","type":"language","creationDate":"2014-3-7","author":"Joomla! Taiwan User Community","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"eddy@joomla.org.tw","authorUrl":"www.joomla.org.tw","version":"3.2.3.1","description":"zh-TW site language","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10001, '', 'language', 'zh-TW', '', 1, 1, 0, 0, '{"name":"\\u4e2d\\u6587(\\u7e41\\u9ad4\\uff0e\\u53f0\\u7063)","type":"language","creationDate":"2014-3-7","author":"Joomla! Taiwan User Community","copyright":"Copyright (C) 2005 - 2014 Open Source Matters All rights reserved. ","authorEmail":"eddy@joomla.org.tw","authorUrl":"www.joomla.org.tw","version":"3.2.3.1","description":"zh-TW administrator language","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10002, 'zh-TW', 'package', 'pkg_zh-TW', '', 0, 1, 1, 0, '{"name":"\\u4e2d\\u6587(\\u7e41\\u9ad4\\uff0e\\u53f0\\u7063)\\u5b8c\\u6574\\u8a9e\\u8a00\\u5305","type":"package","creationDate":"2014-3-7","author":"Joomla! Taiwan User Community","copyright":"Copyright (C) 2005 - 2012 Copyright (C) 2005 - 2014 Open Source Matters  All rights reserved.","authorEmail":"eddy@joomla.org.tw","authorUrl":"www.joomla.org.tw","version":"3.2.3.1","description":"\\n      \\n      <h3>Joomla! 3.2.3v1 \\u4e2d\\u6587(\\u7e41\\u9ad4\\uff0e\\u53f0\\u7063)\\u5b8c\\u6574\\u8a9e\\u8a00\\u5305<\\/h3>\\n      <h3>Joomla! 3.2.3v1 Traditional Chinese (Taiwan) Language Package<\\/h3>\\n      \\n   ","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- 資料表結構 `cmf_finder_filters`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_filters` (
...
--
-- 資料表結構 `cmf_finder_links`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links` (
...
--
-- 資料表結構 `cmf_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_terms0` (
...
--
-- 資料表結構 `cmf_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `cmf_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `cmf_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `cmf_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `cmf_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `cmf_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `cmf_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `cmf_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `cmf_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `cmf_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `cmf_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `cmf_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `cmf_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `cmf_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `cmf_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- 資料表結構 `cmf_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- 資料表的匯出資料 `cmf_finder_taxonomy`
--

INSERT INTO `cmf_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- 資料表結構 `cmf_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- 資料表結構 `cmf_finder_terms`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_terms` (
...
--
-- 資料表結構 `cmf_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- 資料表的匯出資料 `cmf_finder_terms_common`
--

INSERT INTO `cmf_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- 資料表結構 `cmf_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- 資料表結構 `cmf_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- 資料表結構 `cmf_finder_types`
--

CREATE TABLE IF NOT EXISTS `cmf_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cmf_languages` (
...
--
-- 資料表的匯出資料 `cmf_languages`
--

INSERT INTO `cmf_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
INSERT INTO `cmf_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- 資料表結構 `cmf_menu_types`
--

CREATE TABLE IF NOT EXISTS `cmf_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 資料表的匯出資料 `cmf_menu_types`
--

INSERT INTO `cmf_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
...
CREATE TABLE IF NOT EXISTS `cmf_messages` (
...
--
-- 資料表結構 `cmf_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `cmf_messages_cfg` (
...
CREATE TABLE IF NOT EXISTS `cmf_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- 資料表的匯出資料 `cmf_modules`
--

INSERT INTO `cmf_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- 資料表結構 `cmf_modules_menu`
--

CREATE TABLE IF NOT EXISTS `cmf_modules_menu` (
...
--
-- 資料表的匯出資料 `cmf_modules_menu`
--

INSERT INTO `cmf_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
CREATE TABLE IF NOT EXISTS `cmf_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cmf_overrider` (
...
--
-- 資料表結構 `cmf_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `cmf_postinstall_messages` (
...
--
-- 資料表的匯出資料 `cmf_postinstall_messages`
--

INSERT INTO `cmf_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- 資料表結構 `cmf_redirect_links`
--

CREATE TABLE IF NOT EXISTS `cmf_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cmf_schemas` (
...
--
-- 資料表的匯出資料 `cmf_schemas`
--

INSERT INTO `cmf_schemas` (`extension_id`, `version_id`) VALUES
...
CREATE TABLE IF NOT EXISTS `cmf_session` (
...
--
-- 資料表的匯出資料 `cmf_session`
--

INSERT INTO `cmf_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('orphtn1g9n2p6gvmdlf1nc47q4', 1, 0, '1395045860', '__default|a:8:{s:15:"session.counter";i:7;s:19:"session.timer.start";i:1395045848;s:18:"session.timer.last";i:1395045858;s:17:"session.timer.now";i:1395045860;s:22:"session.client.browser";s:120:"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.152 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":2:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}}}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"279";s:4:"name";s:10:"Super User";s:8:"username";s:5:"smstw";s:5:"email";s:21:"service@bm-sms.com.tw";s:8:"password";s:34:"$P$DJ9ygEXhN9o2F0v53Q5FgeaY/wIk7K/";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2014-03-17 08:43:46";s:13:"lastvisitDate";s:19:"0000-00-00 00:00:00";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"4a8c8c3e45d6c6ef4fcdff56a55d7db9";}', 279, 'smstw');
...
CREATE TABLE IF NOT EXISTS `cmf_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `cmf_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- 資料表結構 `cmf_template_styles`
--

CREATE TABLE IF NOT EXISTS `cmf_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 資料表的匯出資料 `cmf_template_styles`
--

INSERT INTO `cmf_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
CREATE TABLE IF NOT EXISTS `cmf_ucm_base` (
...
--
-- 資料表結構 `cmf_ucm_content`
--

CREATE TABLE IF NOT EXISTS `cmf_ucm_content` (
...
--
-- 資料表結構 `cmf_ucm_history`
--

CREATE TABLE IF NOT EXISTS `cmf_ucm_history` (
...
CREATE TABLE IF NOT EXISTS `cmf_updates` (
...
--
-- 資料表的匯出資料 `cmf_updates`
--

INSERT INTO `cmf_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
(4, 3, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/fr-FR_details.xml', '', ''),
(5, 3, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/de-DE_details.xml', '', ''),
(6, 3, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '3.2.0.1', '', 'http://update.joomla.org/language/details3/el-GR_details.xml', '', ''),
(7, 3, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/ja-JP_details.xml', '', ''),
(8, 3, 0, 'Hebrew', '', 'pkg_he-IL', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/he-IL_details.xml', '', ''),
(9, 3, 0, 'EnglishAU', '', 'pkg_en-AU', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/en-AU_details.xml', '', ''),
(10, 3, 0, 'EnglishUS', '', 'pkg_en-US', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/en-US_details.xml', '', ''),
(11, 3, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/hu-HU_details.xml', '', ''),
(12, 3, 0, 'Afrikaans', '', 'pkg_af-ZA', 'package', '', 0, '3.2.0.1', '', 'http://update.joomla.org/language/details3/af-ZA_details.xml', '', ''),
(13, 3, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/ar-AA_details.xml', '', ''),
...
(16, 3, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/ca-ES_details.xml', '', ''),
...
(19, 3, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/cs-CZ_details.xml', '', ''),
(20, 3, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/da-DK_details.xml', '', ''),
(21, 3, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/nl-NL_details.xml', '', ''),
(22, 3, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/et-EE_details.xml', '', ''),
(23, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/it-IT_details.xml', '', ''),
(24, 3, 0, 'Korean', '', 'pkg_ko-KR', 'package', '', 0, '3.2.1.0', '', 'http://update.joomla.org/language/details3/ko-KR_details.xml', '', ''),
(25, 3, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/lv-LV_details.xml', '', ''),
(26, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', '', ''),
(27, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.2.2.1', '', 'http://update.joomla.org/language/details3/nb-NO_details.xml', '', ''),
(28, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/fa-IR_details.xml', '', ''),
(29, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/pl-PL_details.xml', '', ''),
(30, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.2.1.5', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', '', ''),
(31, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', '', ''),
(32, 3, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/sv-SE_details.xml', '', ''),
(33, 3, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/sy-IQ_details.xml', '', ''),
(34, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
(35, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/th-TH_details.xml', '', ''),
(36, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', '', ''),
...
(40, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.0.2.1', '', 'http://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(41, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.2.3.3', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
(42, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
(43, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(44, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.2.3.2', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
(45, 3, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/vi-VN_details.xml', '', ''),
(46, 3, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/id-ID_details.xml', '', ''),
(47, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
(48, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.2.3.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
(49, 3, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/srp-ME_details.xml', '', '');

-- --------------------------------------------------------

--
-- 資料表結構 `cmf_update_sites`
--

CREATE TABLE IF NOT EXISTS `cmf_update_sites` (
...
--
-- 資料表的匯出資料 `cmf_update_sites`
--

INSERT INTO `cmf_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1395045860, ''),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1395045860, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1395045860, '');

-- --------------------------------------------------------

--
-- 資料表結構 `cmf_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `cmf_update_sites_extensions` (
...
--
-- 資料表的匯出資料 `cmf_update_sites_extensions`
--

INSERT INTO `cmf_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(3, 10002);
...
--
-- 資料表結構 `cmf_usergroups`
--

CREATE TABLE IF NOT EXISTS `cmf_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- 資料表的匯出資料 `cmf_usergroups`
--

INSERT INTO `cmf_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
INSERT INTO `cmf_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`) VALUES
(279, 'Super User', 'smstw', 'service@bm-sms.com.tw', '$P$DJ9ygEXhN9o2F0v53Q5FgeaY/wIk7K/', 0, 1, '2014-03-17 08:43:46', '2014-03-17 08:44:17', '0', '', '0000-00-00 00:00:00', 0, '', '');
...
CREATE TABLE IF NOT EXISTS `cmf_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 資料表結構 `cmf_user_notes`
--

CREATE TABLE IF NOT EXISTS `cmf_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- 資料表結構 `cmf_user_profiles`
--

CREATE TABLE IF NOT EXISTS `cmf_user_profiles` (
...
--
-- 資料表結構 `cmf_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `cmf_user_usergroup_map` (
...
--
-- 資料表的匯出資料 `cmf_user_usergroup_map`
--

INSERT INTO `cmf_user_usergroup_map` (`user_id`, `group_id`) VALUES
(279, 8);

-- --------------------------------------------------------

--
-- 資料表結構 `cmf_viewlevels`
--

CREATE TABLE IF NOT EXISTS `cmf_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- 資料表的匯出資料 `cmf_viewlevels`
--

INSERT INTO `cmf_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
CREATE TABLE IF NOT EXISTS `cmf_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
